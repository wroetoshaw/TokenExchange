...
export ORDERER_ADDRESS=orderer.simplyfi.com:7050

# RAFT requires TLS
if [ "$2" = "tls" ] || [ "$2" = "raft" ]; then

    export ORDERER_CA_ROOTFILE=$PWD/config/crypto-config/ordererOrganizations/simplyfi.com/orderers/orderer.simplyfi.com/msp/tlscacerts/tlsca.simplyfi.com-cert.pem
...
export CC_CHANNEL_ID="tokenchannel"
