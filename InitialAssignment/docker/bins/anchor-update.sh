...
configtxgen -outputAnchorPeersUpdate ./config/peer-update.tx   -asOrg $ORG_NAME -channelID tokenchannel  -profile TokenChannel

FABRIC_CFG_PATH=$PEER_FABRIC_CFG_PATH

peer channel update -f ./config/peer-update.tx -c tokenchannel -o $ORDERER_ADDRESS $TLS_PARAMETERS
