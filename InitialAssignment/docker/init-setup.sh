...
configtxgen -outputBlock  ./orderer/tokengenesis.block -channelID ordererchannel  -profile TokenOrdererGenesis


echo    "====>Generating the channel create tx"
configtxgen -outputCreateChannelTx  tokenchannel.tx -channelID tokenchannel  -profile TokenChannel
